"""
Django settings for donazioakEmir project.
...
SECRET_KEY = 'django-insecure-0_f)v9)ae^g!^-=(zrc_9jx_em8(%bw0_0=2t67x9dci9r@g=7'
...
ROOT_URLCONF = 'donazioakEmir.urls'
...
WSGI_APPLICATION = 'donazioakEmir.wsgi.application'
